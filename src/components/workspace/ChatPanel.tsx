...
import { Bot, User, Send, Sparkles, Check, Plus } from "lucide-react";
          ...
          <AnimatePresence>
            {buildComplete && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="rounded-lg bg-emerald-500/8 border border-emerald-500/20 px-3 py-2.5 flex items-center gap-2"
              >

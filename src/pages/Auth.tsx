        ...
        <div className="glow-border rounded-xl p-6 bg-card">
          {mode !== "forgot" && (
            <>
              <Button
                variant="outline"
                className="w-full mb-4 gap-2 cursor-pointer border-border hover:bg-secondary"
          ...
          <div className="mt-4 text-center text-sm text-muted-foreground">
            {mode === "forgot" ? (
              <button onClick={() => setMode("signin")} className="text-primary hover:underline cursor-pointer inline-flex items-center gap-1">
              ...
              <>
                ...
                <button onClick={() => setMode("signin")} className="text-primary hover:underline cursor-pointer">
                  Sign in
                </button>
              </>
            )}
